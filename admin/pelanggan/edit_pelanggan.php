...
<head>
    ...
    <title>Edit Pelanggan | AplikasKasir</title>
    <!-- bootstrap css -->
                    ...
                    <div class="col-md-10">
                        ...
                        <form action="update_pelanggan.php" method="post">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="id_pelanggan" class="form-control" value="<?php echo $row['id_pelanggan'];?>" hidden>
                                <input type="text" name="nama_pelanggan" class="form-control" value="<?php echo $row['nama_pelanggan'];?>">
                            </div>
                            <div class="form-group mb-3">
                                <label for="" class="form-label">Alamat</label>
                                <textarea name="alamat" class="form-control" rows="3" value="<?php echo $row['alamat'];?>" ><?php echo $row['alamat'];?></textarea>
                            </div>
                            <div class="form-group mb-4">
                                <label for="" class="form-label">Nomor Telepon</label>
                                <input type="number" name="nomor_telepon" class="form-control" value="<?php echo $row['nomor_telepon'];?>" >
                            </div>

                            <button type="submit"  class="btn btn-warning w-100">Update Pelanggan</button>
                        </form>
                        <?php } ?>
                    </div>
                    <!-- end form -->
